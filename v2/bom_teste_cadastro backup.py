...
frame_transformador.pack(padx=40, pady=30, fill="both", expand=True)
...
tk.Label(frame_content, text="Nome do Transformador:", font=("Arial", 11)).grid(row=0, column=0, sticky="w", padx=5, pady=5)
...
tk.Label(frame_content, text="Potência (P) [kVA]:", font=("Arial", 11)).grid(row=1, column=0, sticky="w", padx=5, pady=5)
entry_potencia = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_potencia.grid(row=1, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Tensão Primária (Vprim) [V]:", font=("Arial", 11)).grid(row=2, column=0, sticky="w", padx=5, pady=5)
entry_vprim = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_vprim.grid(row=2, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Tensão Secundária (Vsec) [V]:", font=("Arial", 11)).grid(row=3, column=0, sticky="w", padx=5, pady=5)
entry_vsec = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_vsec.grid(row=3, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Impedância (%) [Z%]:", font=("Arial", 11)).grid(row=4, column=0, sticky="w", padx=5, pady=5)
entry_zpercent = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_zpercent.grid(row=4, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Potência de Curto (Pcut) [kVA]:", font=("Arial", 11)).grid(row=5, column=0, sticky="w", padx=5, pady=5)
entry_pcut = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_pcut.grid(row=5, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Corrente Primária (Iprim) [A]:", font=("Arial", 11)).grid(row=6, column=0, sticky="w", padx=5, pady=5)
entry_iprim = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_iprim.grid(row=6, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Corrente Secundária (Isec) [A]:", font=("Arial", 11)).grid(row=7, column=0, sticky="w", padx=5, pady=5)
entry_isec = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_isec.grid(row=7, column=1, padx=5, pady=5)

tk.Label(frame_content, text="R0 (pu):", font=("Arial", 11)).grid(row=8, column=0, sticky="w", padx=5, pady=5)
entry_r0 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_r0.grid(row=8, column=1, padx=5, pady=5)

tk.Label(frame_content, text="X0 (pu):", font=("Arial", 11)).grid(row=9, column=0, sticky="w", padx=5, pady=5)
entry_x0 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_x0.grid(row=9, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Z0 (pu):", font=("Arial", 11)).grid(row=10, column=0, sticky="w", padx=5, pady=5)
entry_z0 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_z0.grid(row=10, column=1, padx=5, pady=5)

tk.Label(frame_content, text="R1 (pu):", font=("Arial", 11)).grid(row=11, column=0, sticky="w", padx=5, pady=5)
entry_r1 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_r1.grid(row=11, column=1, padx=5, pady=5)

tk.Label(frame_content, text="X1 (pu):", font=("Arial", 11)).grid(row=12, column=0, sticky="w", padx=5, pady=5)
entry_x1 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_x1.grid(row=12, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Z1 (pu):", font=("Arial", 11)).grid(row=13, column=0, sticky="w", padx=5, pady=5)
entry_z1 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_z1.grid(row=13, column=1, padx=5, pady=5)

# Adicionando R2, X2, Z2
tk.Label(frame_content, text="R2 (pu):", font=("Arial", 11)).grid(row=14, column=0, sticky="w", padx=5, pady=5)
entry_r2 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_r2.grid(row=14, column=1, padx=5, pady=5)

tk.Label(frame_content, text="X2 (pu):", font=("Arial", 11)).grid(row=15, column=0, sticky="w", padx=5, pady=5)
entry_x2 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_x2.grid(row=15, column=1, padx=5, pady=5)

tk.Label(frame_content, text="Z2 (pu):", font=("Arial", 11)).grid(row=16, column=0, sticky="w", padx=5, pady=5)
entry_z2 = tk.Entry(frame_content, width=40, font=("Arial", 11))
entry_z2.grid(row=16, column=1, padx=5, pady=5)

# Botões de ação
frame_buttons = tk.Frame(frame_content)
frame_buttons.grid(row=17, column=0, columnspan=2, pady=40)
